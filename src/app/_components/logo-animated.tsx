...
export default function LogoAnimated({ type }: { type: "navbar" | "hero" }) {
  if (type === "navbar") {
    return (
      <div data-testid="logo" className="react-logo-container-nav m-auto flex items-center justify-center">
    ...
    return (
      <div data-testid="logo" className="react-logo-container m-auto flex items-center justify-center">
